...
import com.szh.generate.generatebeanfilein.BeanAutoDao;
import com.szh.generate.generatebeanfilein.GetTablesDao;
import com.szh.generate.generatebeanfileutils.ConfigUtil;
import com.szh.generate.generatebeanfileutils.DataTypeUtil;
import com.szh.generate.generatebeanfileutils.FileUtil;
import com.szh.generate.generatebeanfileutils.NameUtil;
...
//(实体类）文件内容
                ...
                importCon.append("import"+"\t"+"com.gddxit.wwis.union."+ConfigUtil.beanHead+"_TABLE;\n");
                String beanHead = "@Entity(name= "+ConfigUtil.beanHead+"_TABLE."+list.get(i).getTableName()+")\n";

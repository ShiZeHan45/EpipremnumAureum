...
import com.szh.generate.generatebeanfilein.RepositoryAutoDao;
import com.szh.generate.generatebeanfileutils.ConfigUtil;
import com.szh.generate.generatebeanfileutils.DbInfoUtil;
...
//(实体类）文件内容
                ...
                String className ="public"+"\t"+"interface"+"\t"+fileName+" extends JpaRepository<"+baseName+"Bean, Integer>,JpaSpecificationExecutor<"+baseName+"Bean>{\n\n";
//拼接(实体类）文件内容
